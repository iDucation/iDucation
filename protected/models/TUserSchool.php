 ...
 *
 * The followings are the available columns in table 'user_school':
 ...
 * @property User $user
 */
class TUserSchool extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_school_id, user_id, school, graduate, description', 'safe', 'on'=>'search'),
		);
	}
	 ...
	 * @return TUserSchool the static model class
	 */
