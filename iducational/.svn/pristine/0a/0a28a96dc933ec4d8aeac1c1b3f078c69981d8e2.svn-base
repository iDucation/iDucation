 ...
 * @property User $user
 * @property Discuss $discuss
 */
class TUserInterest extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_interest_id, user_id, discuss_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'discuss' => array(self::BELONGS_TO, 'Discuss', 'discuss_id'),
		);
	}
	 ...
	 * @return TUserInterest the static model class
	 */
